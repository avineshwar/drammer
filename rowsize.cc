...
std::vector<struct model> models = {
    //  model         ro.product.name     board            platform  ion  row
    //  generic name

    // Snapdragon 820
    // {"SM-G935T",  "hero2qltetmo",     "msm8996",       "msm8996", 21,  0,
    // "Samsung Galaxy S7 Edge"},
    // {"SAMSUNG-SM-G930A", "heroqlteuc","MSM8996",       "msm8996", 21,  0,
    // "Samsung Galaxy S7"},

    // Snapdragon 810
    // {"Nexus 6P",  "angler",           "angler",        "msm8994", 21,  0,
    // "Huawei Nexus 6P"},
    ...
    // Snapdragon 805
    {"SM-G901F", "kccat6xx", "APQ8084", "apq8084", 21, K(128),
     "Samsung Galaxy S5 Plus"},
    // {"SM-N910V",  "trltevzw",         "APQ8084",       "apq8084", 21,  0,
    // "Samsung Galaxy Note 4"},

    // Snapdragon 800
    {"Nexus 5", "hammerhead", "hammerhead", "msm8974", 21, K(64), "LG Nexus 5"},
    {"A0001", "bacon", "MSM8974", "msm8974", 21, K(128), "OnePlus One"},
    {"SM-G870F", "klteactivexx", "MSM8974", "msm8974", 21, K(64),
     "Samsung Galaxy S5 Active"},
    // {"SM-G900T",  "kltetmo",          "MSM8974",       "msm8974", 21,  0,
    // "Samsung Galaxy S5"},

    // Snapdragon 410:
    // {"SM-A500FU", "a5ultexx",         "MSM8916",       "msm8916", 21,  0,
    // "Samsung Galaxy A5"},
    // {"MotoG3",    "osprey_retus",     "msm8916",       "msm8916", 21,  0,
    // "Motorola Moto G 3rd Gen"},
    {"GT-I9195I", "serranoveltexx", "MSM8916", "msm8916", 21, K(32),
     "Samsung Galaxy S4 Mini"},
    {"KIW-L21", "KIW-L21", "KIW-L21", "msm8916", 21, K(32), "Huawei Honor 5X"},
    {"MotoE2(4G-LTE)", "surnia_reteu", "msm8916", "msm8916", 21, K(32),
     "Motorola Moto E 2nd Gen"},
    {"MotoG3", "osprey_reteu", "msm8916", "msm8916", 21, K(32),
     "Motorola Moto G 3rd Gen"},
    {"HUAWEI RIO-L01", "RIO-L01", "RIO-L01", "msm8916", 21, K(64),
     "Huawei GX8/G8"},
    {"HTC One M8s", "m8qlul_htc_europe", "msm8939", "msm8916", 21, K(64),
     "HTC One M8s"},

    // Snapdragon 400:
    {"XT1064", "titan_retuaws", "MSM8226", "msm8226", 21, K(32),
     "Motorola Moto G 2nd Gen"},
    {"XT1068", "titan_retaildsds", "MSM8226", "msm8226", 21, K(32),
     "Motorola Moto G 2nd Gen"},
    // {"LG-V410",   "e7lte_att_us",     "MSM8226",       "msm8226", 21,  0, "LG
    // G Pad 7.0"},

    {"SM-J320FN", "j3xnltexx", "SC9830I", "sc8830", 2, K(32),
     "Samsung Galaxy J3 2016"},
    {"SM-A310F", "a3xeltexx", "universal7580", "exynos5", 4, K(64),
     "Samsung Galaxy A3 2016"}, // not sure about the rowsize...
    {"SM-A700F", "a7altexx", "universal5430", "exynos5", 4, K(128),
     "Samsung Galaxy A7"},
    {"SM-G920F", "zerofltexx", "universal7420", "exynos5", 4, K(128),
     "Samsung Galaxy S6"},
    {"SM-G935F", "hero2ltexx", "universal8890", "exynos5", 4, K(256),
     "Samsung Galaxy S7 Edge"},
    {"SM-G930F", "heroltexx", "universal8890", "exynos5", 4, K(256),
     "Samsung Galaxy S7"},
    // {"SM-T710",   "gts28wifixx",      "universal5433", "exynos5",  4,  0,
    ...
    // {"SM-T710",   "gts28wifixx",      "universal5433", "exynos5",  4,  0,
    // "Samsung Galaxy Tab S2 8.0"},
    // {"SM-T810",   "gts210wifixx",     "universal5433", "exynos5",  4,  0,
    // "Samsung Galaxy Tab S2 9.7"},
    {"SM-N910C", "treltexx", "universal5433", "exynos5", 4, K(64),
     "Samsung Galaxy Note 4"},
    ...
    {"ALE-L21", "ALE-L21", "BalongV8R1SFT", "hi6210sft", 1, K(32),
     "Huawei P8 Lite"},
    {"EVA-L09", "EVA-L09", "EVA-L09", "hi3650", 1, K(64), "Huawei P9"},
    {"HUAWEI VNS-L31", "VNS-L31", "VNS-L31", "hi6250", 1, K(32),
     "Huawei P9 Lite"},

    {"NEO6_LTE", "NEO6_LTE", "", "mt6735", 1, K(32), "Odys Neo 6"},

    {"HTC Desire 830 dual sim", "a51cml_dtul_00401", "", "mt6753", 1, K(64),
     "HTC Desire 830"},

    {"E5603", "E5603", "", "mt6795", 1, K(64), "Sony Xperia M5"}

    // MT6572
    // {"Goophone i5C", "mbk72_wet_jb3", "mbk72_wet_jb3", "",        21,  0,
    // "Goophone i5C"},
...
uint64_t compute_mad(std::vector<uint64_t> &v) {
  ...
  for (auto it : v) {
    if (it < median)
      absolute_deviations.push_back(median - it);
    else
      absolute_deviations.push_back(it - median);
  }
  sort(absolute_deviations.begin(), absolute_deviations.end());
  return compute_median(absolute_deviations);
}

uint64_t compute_iqr(std::vector<uint64_t> &v, uint64_t *q1, uint64_t *q2,
                     uint64_t *q3) {
...
int RS_autodetect(void) {
  ...
  int page1 = 0;
  volatile uintptr_t *virt1 =
      (volatile uintptr_t *)((uint64_t)data.mapping + (page1 * PAGESIZE));
  for (int page2 = 0; page2 < ROWSIZE_PAGES; page2++) {
    volatile uintptr_t *virt2 =
        (volatile uintptr_t *)((uint64_t)data.mapping + (page2 * PAGESIZE));
  ...
  if (!VALID_ROWSIZES.count(rowsize)) {
    if (familiarity == FAMILIAR_MODEL) {
      print("[RS] WARNING! Weird row size detected, assuming familiar model's "
            "rowsize %d\n",
            m->rowsize);
      rowsize = m->rowsize;
    } else {
